...
const meeting = { id: 3, club_id: 2, club_name: "Calendar Club", creator_id: 1, organizer: user, title: "Chapter discussion", description: "Discuss chapters", start_time: "2026-08-20T18:00:00Z", end_time: "2026-08-20T19:00:00Z", timezone: "UTC", location: "Room 4", status: "SCHEDULED", created_at: "2026-08-01T00:00:00Z", attendees: [{ id: 1, status: "GOING", user }], viewer_rsvp: "GOING" };
